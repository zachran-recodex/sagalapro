...
@section('content')
    ...
    <div class="flex items-center justify-between flex-wrap gap-2 mb-6">
        <h4 class="text-default-900 text-lg font-medium">Edit Hero Section</h4>
                        ...
                        <div class="p-6">
                            ...
                            <div class="mb-4">
                                ...
                                <p class="text-gray-500 text-sm mt-1">Current Image: <img
                                        src="{{ Storage::url($heroSection->image) }}" alt="{{ $heroSection->title }}"
                            ...
                            <div class="mb-4">
                                ...
                                <select name="status" id="status"
                                    ...
                                    required>
                                    <option value="1"
                                        {{ old('status', $heroSection->status) == 'true' ? 'selected' : '' }}>
                                        Active
                                    </option>
                                    <option value="0"
                                        {{ old('status', $heroSection->status) == 'false' ? 'selected' : '' }}>
                                        Not Active
                                    </option>
                                </select>
                                @error('status')
