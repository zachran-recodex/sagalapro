...
@section('content')
    ...
    <div class="flex items-center justify-between flex-wrap gap-2 mb-6">
        <h4 class="text-default-900 text-lg font-medium">Add New faq</h4>

        <div class="md:flex bg-info px-6 py-2 rounded-md hidden items-center gap-3 text-sm font-semibold">
            <a href="{{ route('admin.faqs.index') }}" class="text-sm text-white font-medium text-default-700">Back to
                faq</a>
        </div>
    </div>
    <!-- Page Title End -->
