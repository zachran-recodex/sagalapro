...
@section('content')
    <!-- Hero Section -->
    <section class="bg-cover bg-center bg-no-repeat h-screen" style="background-image: url({{ asset('images/pj.jpg') }})">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-wrap lg:flex-nowrap gap-8 items-center">
                ...
                <div class="w-full lg:w-1/2">
                    <img class="w-full h-auto object-cover" src="{{ asset('images/pj.jpg') }}"
                        alt="Aircraft & Helicopter Acquisition">
                </div>
                <!-- Text Section -->
                <div class="w-full lg:w-1/2">
                    <h2 class="text-[#2A6F97] text-2xl font-bold mb-4">Private Jet Charters & Flights</h2>
                    <p class="mb-4 text-justify">
                        Experience the ultimate in luxury travel with SagalaPro’s private jet charters. Whether for business
                        or leisure, our charters provide a flexible, on-demand solution that puts your comfort and
                        convenience first.
                    </p>
                    <a href=""
    ...
    <!-- Banner Section -->
    <section class="relative bg-cover bg-center bg-no-repeat h-[418px] flex items-center"
        style="background-image: url({{ asset('images/pj.jpg') }}); min-height: 418px;">
        <!-- Black overlay -->
        <div class="absolute inset-0 bg-black opacity-50"></div>
        ...
        <div class="relative container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center text-white">
                <h3 class="text-3xl font-bold mb-4">Business Travel</h3>
                <p class="text-lg">
                    Avoid crowds, maintain productivity, and reach remote destinations quickly with our bespoke business jet
                    services.
                </p>
            </div>
        </div>
