...
@section('content')
    <!-- Hero Section -->
    <section class="bg-cover bg-center bg-no-repeat h-screen" style="background-image: url({{ asset('images/aerial.jpg') }})">
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div class="text-center lg:text-start">
                    ...
                    <h2 class="text-4xl sm:text-6xl font-bold text-white mt-2">
                        Aerial Fire-Fighting Consultant & Operation
                    </h2>
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-wrap lg:flex-nowrap gap-8 items-center">
                ...
                <div class="w-full lg:w-1/2">
                    <img class="w-full h-auto object-cover" src="{{ asset('images/faq.jpg') }}"
                        alt="Aircraft & Helicopter Acquisition">
                </div>
                <!-- Text Section -->
                <div class="w-full lg:w-1/2">
                    <h2 class="text-[#2A6F97] text-2xl font-bold mb-4">Aerial Fire-Fighting Consultant & Operation</h2>
                    <p class="mb-4 text-justify">
                        SagalaPro provides a range of helicopters for various needs, from commercial and recreational to
                        travel and fire-fighting operations. Our helicopters are ideal for reaching remote or congested
                        areas quickly and safely.
                    </p>
                    <p class="mb-4 text-justify">
                        <span class="text-[#2A6F97] font-semibold">Water Bombing: </span>
                        Equipped with helicopters like the Mi-8/171 or Kamov KA-32, capable of carrying 4,000 liters of
                        water with a Bambi bucket, we provide effective fire-fighting solutions across Indonesia, especially
                        during the dry season when forest fires are prevalent.
                    </p>
                    <a href=""
    ...
    <section class="bg-[#F6F6F6] py-8 sm:py-12 lg:py-16">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-wrap lg:flex-nowrap gap-8 items-center">
                <!-- Text Section -->
                <div class="w-full lg:w-1/2">
                    <h2 class="text-[#2A6F97] text-2xl font-bold mb-4">Man Power Provider</h2>
                    <p class="mb-4 text-justify">
                        We offer a comprehensive team for waterbombing operations, including Site Managers, Flight Operation
                        Officers, and Helicopter Landing Officers, equipped with all necessary tools and reporting to ensure
                        smooth operations from start to finish.
                    </p>
                </div>
                <!-- Image Section -->
                <div class="w-full lg:w-1/2">
                    <img class="w-full h-auto object-cover" src="{{ asset('images/manpower.jpg') }}"
                        alt="Aircraft & Helicopter Acquisition">
                </div>
            </div>
        </div>
