...
@section('content')
    <!-- Hero Section -->
    <section class="bg-cover bg-center bg-no-repeat h-screen" style="background-image: url({{ asset('images/cargo.jpeg') }})">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-wrap lg:flex-nowrap gap-8 items-center">
                ...
                <div class="w-full lg:w-1/2">
                    <img class="w-full h-auto object-cover" src="{{ asset('images/cargo.jpeg') }}"
                        alt="Aircraft & Helicopter Acquisition">
                </div>
                <!-- Text Section -->
                <div class="w-full lg:w-1/2">
                    <h2 class="text-[#2A6F97] text-2xl font-bold mb-4">Heavy & Outsized Cargo Service</h2>
                    <p class="mb-4 text-justify">
                        Transporting heavy and outsized cargo requires expertise and precision. SagalaPro leverages in-depth
                        knowledge of cargo aircraft capabilities to arrange the transportation of large and bulky items
                        efficiently and safely. Need immediate delivery? Contact us, and we'll handle the rest.
                    </p>
                    <a href=""
